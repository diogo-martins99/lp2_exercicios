...
2. Apresenta um diagrama UML com a informação mínima e essencial que demonstre
   ...
   https://drive.google.com/file/d/15lMnrGt5WEV5rjUCETesjELNqk9i8qLB/view
...
```cs
    ...
    public class InteraçaoAgresiva : IInteractBehaviour
    {
...
```cs
    ...
    public class InteraçaoInteligente : IInteractBehaviour
    {
        public void Interact()
        {
...
```cs
    ...
    public class BJKing: NPC
    {
        public BJKing()
        {
            ...
            InteractB = new InteraçaoAgresiva();
        }
...
```cs
    ...
    public class MLKing : NPC
    {
        public MLKing()
        {
            ...
            InteractB = new InteraçaoInteligente();
        }
        public override void Display()
        {
